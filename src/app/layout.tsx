  ...
  return (
    <html lang="es">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-zinc-400 min-h-screen flex flex-col`}>
        ...
        <footer className="bg-gray-600 text-white px-4 py-8 text-sm sm:text-xs">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
            {[
              {
                name: "FADENA",
